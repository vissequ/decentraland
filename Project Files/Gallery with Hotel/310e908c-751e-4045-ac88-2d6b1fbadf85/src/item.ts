...
export default class Lamp implements IScript<Props> {
  clip = new AudioClip('310e908c-751e-4045-ac88-2d6b1fbadf85/sounds/Click.mp3')
  ...
  spawn(host: Entity, props: Props, channel: IChannel) {
    ...
    let offModel = new GLTFShape('310e908c-751e-4045-ac88-2d6b1fbadf85/models/Chandelier_Off.glb')
    lampOff.addComponent(offModel)

    const lampOn = new Entity(host.name + '-on')
    lampOn.setParent(host)
    lampOn.addComponent(new Transform())
    let onModel = new GLTFShape('310e908c-751e-4045-ac88-2d6b1fbadf85/models/Chandelier_On.glb')
