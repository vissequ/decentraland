...
export default class Lamp implements IScript<Props> {
  clip = new AudioClip('b79a150e-5914-4fdf-a6b4-c7ff0c6833dd/sounds/Click.mp3')
  ...
  spawn(host: Entity, props: Props, channel: IChannel) {
    ...
    let offModel = new GLTFShape('b79a150e-5914-4fdf-a6b4-c7ff0c6833dd/models/FuturisticLight_Off.glb')
    lampOff.addComponent(offModel)

    const lampOn = new Entity(host.name + '-on')
    lampOn.setParent(host)
    lampOn.addComponent(new Transform())
    let onModel = new GLTFShape('b79a150e-5914-4fdf-a6b4-c7ff0c6833dd/models/FuturisticLight_On.glb')
