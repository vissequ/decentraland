...
export default class Lamp implements IScript<Props> {
  clip = new AudioClip('03829f2d-a9ab-4292-aa97-6f51a02b3ba9/sounds/Click.mp3')
  ...
  spawn(host: Entity, props: Props, channel: IChannel) {
    ...
    let offModel = new GLTFShape('03829f2d-a9ab-4292-aa97-6f51a02b3ba9/models/ChandelierB_Off.glb')
    lampOff.addComponent(offModel)

    const lampOn = new Entity(host.name + '-on')
    lampOn.setParent(host)
    lampOn.addComponent(new Transform())
    let onModel = new GLTFShape('03829f2d-a9ab-4292-aa97-6f51a02b3ba9/models/ChandelierB_On.glb')
