...
export default class Lamp implements IScript<Props> {
  clip = new AudioClip('d14b0ff2-0c2e-47c3-841c-05649e680822/sounds/Click.mp3')
  ...
  spawn(host: Entity, props: Props, channel: IChannel) {
    ...
    let offModel = new GLTFShape('d14b0ff2-0c2e-47c3-841c-05649e680822/models/RoundWallLight_Off.glb')
    lampOff.addComponent(offModel)

    const lampOn = new Entity(host.name + '-on')
    lampOn.setParent(host)
    lampOn.addComponent(new Transform())
    let onModel = new GLTFShape('d14b0ff2-0c2e-47c3-841c-05649e680822/models/RoundWallLight_On.glb')
